      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            UnDraw(illustration: UnDrawIllustration.doctor, color: secondaryColorLight, height: 200, width: 200),
            const SizedBox(height: 12),
            AuthButton(theme: _theme, onTap: (){
              context.pushRoute(const DoctorChatPlanRoute());
            }, label: "Let's Chat"),
            const SizedBox(height: 24),
